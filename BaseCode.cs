...
namespace Com.Mygame {
	...
	public class MyCharacterController {
		...
		public void reset() {
			...
			CoastController coastController = (Director.getInstance ().currentSceneController as FirstController).fromCoast;
	...
	public class CoastController {
		...
		public Vector3 getEmptyPosition() {
			...
			// if(emptyIndex == -1) return Vector3.zero;
	...
	public class BoatController {
		...
		readonly Moveable moveableScript;
		readonly Vector3 fromPosition = new Vector3 (5, 1.75F, 0);
		readonly Vector3 toPosition = new Vector3 (-5, 1.75F, 0);
		...
		public BoatController() {
			...
			from_positions = new Vector3[] { new Vector3 (4.5F, 2.25F, 0), new Vector3 (5.5F, 2.25F, 0) };
			to_positions = new Vector3[] { new Vector3 (-5.5F, 2.25F, 0), new Vector3 (-4.5F, 2.25F, 0) };
